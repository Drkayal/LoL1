    ...
    async def initialize(self):
        ...
        self._session_pool = [
            aiohttp.ClientSession(
                ...
                headers={'User-Agent': f'AnonXMusic-{i}'},
...
class HyperSpeedDownloader:
    ...
    async def download_with_ytdlp(self, video_info: Dict) -> Optional[Dict]:
        ...
        try:
            from AnonXMusic.core.cookies_manager import cookies_manager, report_cookie_success, report_cookie_failure
...
🤖 **بواسطة:** AnonXMusic Smart Cache System V2
...
async def process_smart_youtube_download(event, status_msg, query: str, user_id: int, start_time: float, task_id: str):
    ...
    try:
        ...
        try:
            from AnonXMusic.plugins.play.youtube_api_downloader import search_and_download_hybrid
    ...
    try:
        ...
        if file_path and os.path.exists(file_path):
            ...
            await message.reply_audio(
                ...
                performer=cache_result.get('artist', 'AnonXMusic Bot')
            )
    ...
    try:
        ...
        if file_id:
            ...
            await message.reply_audio(
                ...
                performer=telegram_result.get('artist', 'AnonXMusic Bot')
            )
            ...
            # إعادة توجيه الرسالة باستخدام Pyrogram
            import config
            cache_channel = config.CACHE_CHANNEL_ID
            
            # استخدام copy_message بدلاً من forward_messages للتوافق مع Pyrogram
