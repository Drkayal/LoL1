...
MONGO_DB_URI = getenv("MONGO_DB_URI", "mongodb+srv://huSeen96:Huseenslah96@cluster0.ld2v7.mongodb.net/AAAK1BOT_db?retryWrites=true&w=majority&appName=Cluster0")
OWNER_ID = int("985612253")
LOGGER_ID = int("-1002600059551")
